  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
     ...
     <ul class="navbar-nav ">
      ...
      <li class="nav-item active icon-spacing profile-name">
        <center>
          <a href="#"> 
            <i class="fa fa-user fa-2x profile-name" aria-hidden="true"></i><br>
            <i class="profile-name"><s:property value="#session.loggedUser.getNom()"/></i>
          </a>
        </center>
      </li>

      <li class="nav-item active ">
        <a href="#"><i class="fa fa-sign-out fa-3x icon-spacing" aria-hidden="true"></i></a>
      </li>
     </ul>
  </div>
</nav>

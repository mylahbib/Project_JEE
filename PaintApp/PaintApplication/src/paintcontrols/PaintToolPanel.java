...
public class PaintToolPanel extends JPanel
{
    ...
    public PaintToolPanel(ToolOptionPanel toolOptionPanel)
    {
        ...
        buttons = new ToolButton[5];

        Icon[] icons = new ImageIcon[5];
        ...
        //Icon cercle    = new ImageIcon(getClass().getResource("eraser.png"));
        ...
        //buttons[4] = new ToolButton(eraser, Tool.ERASER);
        buttons[4] = new ToolButton(eraser, Tool.ERASER);
        ...
        buttons[0] = new ToolButton(rectangle, Tool.RECTANGLE);
        buttons[1] = new ToolButton(oval, Tool.OVAL);
        buttons[2] = new ToolButton(lineTool, Tool.LINE);
        buttons[3] = new ToolButton(polygon, Tool.ROUND_RECT);
